...
export const Resande = (props) => {
  ...
  return (
    <div ref={fade} id="resandes">
      <div className="container">
        <div className="resande-title text-center">
          <h2>
            <span className="text">Praktisk info till resande</span>
          </h2>
          <h3>Transport <i className="bi bi-airplane" style={{color: 'black'}}></i></h3>
          <p>
            För er som kommer med flyg tar man sig lättast (och billigast) till
            och från flygplatsen/Bergen Centrum med hjälp av Bybanen. Ladda
            enkelt ned appen ’Skyss Billett’ för biljetter (går även att betala
            med kort på perongen).
          </p>
        </div>
        <div></div>
